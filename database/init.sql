-- 创建数据库
CREATE DATABASE IF NOT EXISTS zht_lab DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS laboratory (
    ...
    name_cn VARCHAR(200) NOT NULL COMMENT '中文名称',
    name_en VARCHAR(200) COMMENT '英文名称',
    type VARCHAR(100) COMMENT '类型：EMC&无线实验室、安规实验室、电池实验室、化学实验室',
    description_cn TEXT COMMENT '中文描述',
    description_en TEXT COMMENT '英文描述',
...
-- 认证服务表
CREATE TABLE IF NOT EXISTS certification_service (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    name_cn VARCHAR(200) NOT NULL COMMENT '中文名称',
    name_en VARCHAR(200) COMMENT '英文名称',
    category VARCHAR(100) COMMENT '分类：欧洲认证、美洲认证、亚洲认证、澳洲认证、国际认证、能效认证、体系认证、可靠性测试、电池检测、化学检测',
    region VARCHAR(100) COMMENT '地区：具体国家或地区',
    description_cn TEXT COMMENT '中文描述',
    description_en TEXT COMMENT '英文描述',
    sort_order INT DEFAULT 0 COMMENT '排序',
    create_time DATETIME DEFAULT CURRENT_TIMESTAMP,
    update_time DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='认证服务表';
...
CREATE TABLE IF NOT EXISTS news (
    ...
    image VARCHAR(500) COMMENT '图片',
    category VARCHAR(100) DEFAULT '行业新闻' COMMENT '分类',
...
CREATE TABLE IF NOT EXISTS honor (
    ...
    create_time DATETIME DEFAULT CURRENT_TIMESTAMP,
    update_time DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='荣誉资质表';
